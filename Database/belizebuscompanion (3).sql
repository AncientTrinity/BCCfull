...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2023 at 08:53 PM
...
--
-- RELATIONSHIPS FOR TABLE `buscompanies`:
--
...
--
-- RELATIONSHIPS FOR TABLE `busschedule`:
--   `begin_locationid`
--       `locationofstop` -> `stoplocid`
--   `end_locationid`
--       `locationofstop` -> `stoplocid`
--   `busid`
--       `bus` -> `busid`
...
--
-- RELATIONSHIPS FOR TABLE `locationofstop`:
--
...
--
-- RELATIONSHIPS FOR TABLE `paymentoptions`:
--   `userid`
--       `userinfo` -> `userid`
--
...
(1, 'Victor', 'Tillett', 'victillettjr@gmail.com', 'Test Address', 6313498, '12345', '332090c47fdc4eda613c91014fc4113c', 1, '2023-05-10 08:46:58');
