<?php 
$pagetitle=" Welcome To Belize Bus Companion";
...
?>
      ...
      <div class="osahan-fotter fixed-bottom m-3">
         <a class="btn btn-block px-4 py-3 d-flex align-items-center osahanbus-btlan btn-danger text-white shadow" href="get-started.php">
